...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query(`
      ...
      FROM public.recipe_order AS o
      LEFT JOIN public.recipe_run AS rr ON o.recipe_run_id = rr.id
      LEFT JOIN public.recipe_order_group as og ON o.recipe_run_id = og.recipe_run_id
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query('DROP VIEW av_recipe_orders');
  }
};