...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query('DROP VIEW IF EXISTS av_recipe_orders').then(done => {
        ...
        SELECT 
          ...
          (
            ...
            END
					...
					eo.filled_quantity as filled_quantity,
          o.spend_amount,
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.sequelize.query('DROP VIEW IF EXISTS av_recipe_orders').then(() => {
      return queryInterface.sequelize.query(`
      CREATE OR REPLACE VIEW av_recipe_orders (
        id,
        recipe_run_id,
