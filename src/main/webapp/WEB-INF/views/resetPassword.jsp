...
<script>
	$(document).ready(function() {
		var updatePassword = '${errorMessage}';
		if (updatePassword != 0) {
			$("#errorMsg").html("<center><h2>"+updatePassword+"</h2><br>Click here for reset your password <a href=\'forgotPassword\'>click here</a></center>");
		}
		else{
			$("#formDiv").show();
		}
