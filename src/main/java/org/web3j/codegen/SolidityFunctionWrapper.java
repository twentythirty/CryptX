...
public class SolidityFunctionWrapper {
    ...
    public void generateJavaFiles(
            String contractName, String abi, String destinationDirLocation,
            String basePackageName)
            throws IOException, ClassNotFoundException {
        String className = Strings.capitaliseFirstLetter(contractName);

        TypeSpec.Builder classBuilder = createClassBuilder(className);
    ...
    private TypeSpec.Builder createClassBuilder(String className) {
